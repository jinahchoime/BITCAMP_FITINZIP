...
<div style="display:inline-block; width: 800px;" class="ml30 mt200">
	...
	<div class="mt40">
    	<div>
    		<h5>회원탈퇴 사유</h5>
    		<label><input type="radio" name ="breakReason" value="rejoin" style="display: inline" class="mr5">회원탈퇴 후 재가입을 위해서</label><br>
    	...
    	<div class="mt30">
    		...
    		<textarea rows="5" cols="80" placeholder=" 피트인집에 하시고 싶은 말씀이 있으시면 남겨주세요!"></textarea>
    	</div>
    	<div class="mt30">
    		<h5>회원탈퇴 동의</h5>
    		<label><input type="checkbox" name ="agree" value="agree" style="display: inline" class="mr5">회원탈퇴 안내를 모두 확인하였으며 탈퇴에 동의합니다</label>
    	</div>
   	</div>
   	<input type="submit" class="btn_basic type5 adClick mt50" value="탈퇴하기">
</div>
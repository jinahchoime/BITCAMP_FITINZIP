...
<div style="display:inline-block; width: 800px; margin-top: 120px;" class="ml30">
    <div class="column_left_wrap clearfix" style="width: 1098px;">
        ...
        <div class="notice_wrap">
            <p>쿠폰사용전에 꼭 확인하세요!</p>
            <ul>
                <li>다른 쿠폰과 중복 사용이 불가하며, 1회 계산시 1개의 쿠폰만 사용 가능합니다.</li>
                <li>쿠폰의 할인금액, 할인상품, 사용조건 등을 확인하시기 바랍니다.</li>
                <li>유효기간이 만료된 쿠폰은 사용이 불가하오니 쿠폰의 유효기간을 꼭 확인해주세요.</li>
                <li>사용 후 취소한 주문 건의 쿠폰은 사용기간 종료전에만 재지급됩니다.</li>
                <li>쿠폰에 표기된 금액보다 적은 금액을 결제하셔도 쿠폰은 소진됩니다.</li>
            </ul>
        </div> 
    </div>
</div>

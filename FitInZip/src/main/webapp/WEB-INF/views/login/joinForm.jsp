...
<link rel="stylesheet" type="text/css" href="/resources/login/css/join.css">
...
<script>
	...
	function lastday() { /* 년과 월에 따라 마지막 일 구하기 제발 */
		...
		<div class="contents">
            ...
            <div class="step1">
                ...
                <article class="last-box mt30">
                	<button type="button" class="btn_basic full" id="sendData">가입하기</button>
                </article>
            </div>

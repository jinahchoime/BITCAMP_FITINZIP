            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">강사님 반가워요!</h1>
					...
					<div class="image" style="flex-wrap:wrap;margin-right:-.25rem;margin-left:-.25rem; position: relative;
                        ...
                        <div class="col-xl-3 col-md-6 mb-4" style="margin-left: 55%">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                	등록 신청한 클래스</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">${reqClass }개</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                	나의 클래스</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">${ingClass }개</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4" style="margin-left: 55%">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">정산금
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">${totalCal }원</div>
                                                </div>
                                                <!-- <div class="col">
